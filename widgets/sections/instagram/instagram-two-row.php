...
<div class="<?php _e($class_preflix,'ella') ?>-instagram instagram-two-row <?php if($settings['toggle_bg'] == 'yes') echo "background" ?>">
    ...
    <div class="<?php _e($class_preflix,'ella') ?>-two-row-instagram" 
