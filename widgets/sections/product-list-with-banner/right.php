<div class="<?php _e($class_preflix,'ella') ?>-product-list-with-banner right">
    <div class="<?php _e($class_preflix,'ella') ?>-product-list-with-banner-container row-divide">
        <div class="<?php _e($class_preflix,'ella') ?>-product-list-with-banner-container-product col-divide-md-12 col-divide-lg-6 column-product-right-plugin">
