    ...
    <div class="widget-title not-before style-3">
        ...
        <div class="countdown countdown-style-market">
            ...
            <div class="countdown-item-fld countdown-suppermarket"
                data-countdown-parallax="<?php echo $settings['due_date_flash_deals']; ?>">
                <div class="clock-item-mc">
                    <span class="num-cd" id="numberDaysFlashDeals">00</span>
                    <span class="text-cd">d</span>
                </div>
                <div class="clock-item-mc">
                    <span class="num-cd" id="numberHoursFlashDeals">00</span>&nbsp;:
                </div>
                <div class="clock-item-mc">
                    <span class="num-cd" id="numberMinsFlashDeals">00</span>&nbsp;:
                </div>
                <div class="clock-item-mc">
                    <span class="num-cd" id="numberSecsFlashDeals">00</span>
                </div>
            </div>
        </div>
