...
jQuery( document ).ready(function($) {
    let elementorEditorCheckParallax = document.querySelector('body.elementor-editor-active');
    function CountdownParallax(){
        if(document.querySelector('.parallax-countdown')){
            ...
            if(deatQuery){
              var countDownDate = new Date(deatQuery.getAttribute("data-countdown-parallax")).getTime();
